...
```
Remove-AzServiceFabricManagedNodeType [-Name] <String> -ManagedClusterInputObject <IServiceFabricIdentity>
...
Remove the node type from the cluster.
This will delete the node type.
