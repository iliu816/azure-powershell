...
```
New-AzServiceFabricManagedNodeType -ClusterName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-DscpConfigurationId <String>] [-EnableAcceleratedNetworking] [-EnableEncryptionAtHost]
 [-EnableNodePublicIP] [-EnableNodePublicIPv6] [-EnableOverProvisioning] [-EphemeralPortEndPort <Int32>]
 ...
 [-ZoneBalance] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityManagedClusterExpanded
```
New-AzServiceFabricManagedNodeType -ManagedClusterInputObject <IServiceFabricIdentity> -Name <String>
