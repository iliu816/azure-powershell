...
```
Resume-AzServiceFabricManagedClusterApplicationUpgrade -ApplicationName <String> -ClusterName <String>
 -ResourceGroupName <String> -Parameter <IRuntimeResumeApplicationUpgradeParameters>
...
```
Resume-AzServiceFabricManagedClusterApplicationUpgrade -InputObject <IServiceFabricIdentity>
 [-UpgradeDomainName <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm]
...
```
Resume-AzServiceFabricManagedClusterApplicationUpgrade -ApplicationName <String>
 -ManagedClusterInputObject <IServiceFabricIdentity> [-UpgradeDomainName <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: System.String
Parameter Sets: Resume, ResumeExpanded, ResumeViaIdentityManagedCluster, ResumeViaIdentityManagedClusterExpanded, ResumeViaJsonFilePath, ResumeViaJsonString
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ServiceFabric.Models.IServiceFabricIdentity
Parameter Sets: ResumeViaIdentityManagedCluster, ResumeViaIdentityManagedClusterExpanded
Aliases:
...
Parameter Sets: Resume, ResumeViaIdentity, ResumeViaIdentityManagedCluster
Aliases:
...
```yaml
Type: System.String
Parameter Sets: ResumeExpanded, ResumeViaIdentityExpanded, ResumeViaIdentityManagedClusterExpanded
Aliases:
